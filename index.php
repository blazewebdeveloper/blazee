...
// Assuming you have an array called $data containing the user information
$data = $_POST; // Change this line based on how you receive your data
...
$sql = "INSERT INTO `database1`.`contacts` (`name`, `address`, `number`, `email`, `subject`, `message`,`created`) VALUES ('$name', '$address', '$number', '$email', '$subject', '$message',current_timestamp());";
echo $sql;
